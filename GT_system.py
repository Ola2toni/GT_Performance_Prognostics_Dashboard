    ...
    for col in numerical_cols:
        if len(df[col]) > 11:
            df[col] = savgol_filter(
                df[col], window_length=15, polyorder=2
                )
...
pickle.dump(
    features,
    open("correct_models/features.pkl", "wb")
)
...
pickle.dump(
    scaler,
    open("correct_models/scaler.pkl", "wb")
)
...
def evaluate_models(
    ...
    for name, model in models.items():
        ...
        if name == "ANN":
            ...
            torch.save(
                ...
                f"correct_models/{target_name}_ANN.pth"
            )
        ...
        # ==========================================
            ...
            pickle.dump(
                ...
                open(
                    ...
                    f"correct_models/{target_name}_{name}.pkl",
    ...
    results_df.to_csv(
        ...
        f"correct_models/{target_name}_metrics.csv",
